/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=worker/wrangler.jsonc worker/src/worker-configuration.d.ts` (hash: 4bb8e6d1629d488d0fcae404752cd8aa)
